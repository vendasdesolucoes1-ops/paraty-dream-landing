...
// Planner (gemini-3-flash-preview, Google direto): estimativa a priori
// conservadora. O valor REAL é calculado no plan-post via usageMetadata e
// gravado em imagery_logs — o thinking do modelo faz o custo variar.
